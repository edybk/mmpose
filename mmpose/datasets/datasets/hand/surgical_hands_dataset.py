...
class SurgicalHands(Kpt2dSviewRgbImgTopDownDataset):
    """APAS Dataset for top-down hand pose estimation.

    APAS Hand keypoint indexes::
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile(
                'configs/_base_/datasets/surgical_hands.py')
    ...
    def _get_db(self):
        ...
        for img_id in self.img_ids:
            ...
            for obj in objs:
                ...
                keypoints = np.array(obj[f'keypoints']).reshape(
                    -1, 3)
